import os
import re
from huggingface_hub import HfApi, logging as hf_logging, create_repo
...
def upload_checkpoint_to_hf(
    ...
    try:
        ...
        create_repo(repo_id=hf_repo_id_for_run, repo_type="model", exist_ok=True)
    ...
    if hf_keep_latest_k > 0:
        ...
        try:
            repo_files = api.list_repo_tree(hf_repo_id_for_run, repo_type="model", recursive=False)
            step_folders = [
